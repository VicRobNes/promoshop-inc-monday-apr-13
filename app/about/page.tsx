...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white text-[#1a1a1a]">
      ...
      {/* Hero Section */}
      <section className="py-16 lg:py-24 px-6 lg:px-8 bg-[#f9f9f9]">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-[#666] leading-relaxed font-visby">
              Welcome to our store, where promoting your business is our business. Born from an expertise in building brands, we offer unique, quality promotional products, excellent service, and customer-focused marketing. From our office, we are your premier source for branding solutions!
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#666] leading-relaxed mb-4 font-visby">
              ...
              <p className="text-[#666] leading-relaxed mb-6 font-visby">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <div 
                key={index}
                className="bg-[#f9f9f9] border border-[#e5e5e5] rounded-lg p-6 text-center hover:border-[#ef473f] transition-colors"
              >
                <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-white border border-[#e5e5e5] flex items-center justify-center">
